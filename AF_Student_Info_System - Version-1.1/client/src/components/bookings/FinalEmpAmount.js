    ...
    return (
      <div>
        ...
        <Link
          to=""
          className="nav-link"
          style={{ backgroundColor: "#46494A", color: "black" }}
        >
          <h6 style={{ color: "white" }}>
            Government Employee Calculation Portal
          </h6>
        </Link>
          ...
          <div className="container">
            ...
            >
              ...
              <div className="indata">
                <h6>
                  Here is the Total Amount you have to pay with the Discount
                </h6>
        ...
        <Link className="nav-link" style={{ backgroundColor: "red" }}>
          <h6 style={{ color: "white" }}>
            If you have a Government Employee recognized NIC card you are
            allowed to earn a Discount of 5 %
          </h6>
        </Link>
      </div>
    );
