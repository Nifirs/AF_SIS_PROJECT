  ...
  render() {
    ...
    return (
      <div className="nextEach">
        <Card className={classes.card} style={{backgroundColor:"#58D6F2"}}>
          <CardHeader
            avatar={
          ...
          />
          <CardMedia style={{margin:"12px"}} className={classes.media} image={t2} title="Paella dish" />
          <CardContent>
...
{/* ///2 */}
        <Card className={classes.card} style={{backgroundColor:"#9BE1F1"}}>
          <CardHeader
            avatar={
              <Avatar aria-label="Recipe" className={classes.avatar}>
               VM
          ...
          />
          <CardMedia style={{margin:"12px"}} className={classes.media} image={atm} title="ATM" />
          <CardContent>
            <Typography component="p">
            <b>~Vision~</b>
            <br/><br/>
...
{/* ///3 */}
        <Card className={classes.card} style={{backgroundColor:"#B2DBE5"}}>
          <CardHeader
            avatar={
              <Avatar aria-label="Recipe" className={classes.avatar}>
                RR
