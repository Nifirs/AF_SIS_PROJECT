...
class View extends Component {
    ...
    render(){
        ...
        return (
            <div className={'app-page-download'} style={{background:'pink'}}>
                            ...
                            <div className={'app-download-file-list'}>
                                {
                                    files.map((file, index) => {
                                        ...
                                        return (<div key={index} className={'app-download-file-list-item'}>
                                            <div className={'name'}>{_.get(file,'originalName')}</div>
                                            <div className={'download-action'} style={{color:'red'}}><a href={`${apiUrl}/download/${_.get(file, '_id')}`}>Download</a></div>
                                        </div>)
                                    })
                                }
