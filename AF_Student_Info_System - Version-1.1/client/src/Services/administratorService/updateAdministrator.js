...
class updateAdministrator extends Component {
  ...
  onSubmit(e) {
    ...
    this.props.history.push("/viewAdministrator");
  }
              ...
              <div className="col-md-8 m-auto">
                ...
                <Link to="/viewStudent" className="btn btn-light">
                  <i class="fa fa-chevron-circle-left" aria-hidden="true">
                    &nbsp;Back to Administrators Details
                  </i>
                </Link>
                <br />
                <br />
                <h6 style={{ color: "white" }}>Update-Administrators Details</h6>
                ...
                <form onSubmit={this.onSubmit}>
                  ...
                  <div className="form-group">
                    <h6>Enter Administrator E-mail</h6>
                    <input
                      type="text"
                      className="form-control form-control-lg"
