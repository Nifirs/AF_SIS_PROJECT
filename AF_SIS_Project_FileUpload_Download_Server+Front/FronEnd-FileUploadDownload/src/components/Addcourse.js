...
export default class Addcourse extends React.Component {
    ...
    render(){
        ...
        return(
            <div>
                <div align="left"  style={{width:"500px",backgroundColor:"grey",padding:"5px",height:"650px"}}>
                    <pre>
                            <h3> Create Exam</h3>
                                 <form onSubmit={this.onSubmit} >

                                     <label>Exam date  : </label><br/>
                                     <input type="text" className="form-control" value={this.state.coursename} onChange={this.changecoursename } required /><br/>
                                     <label>Exam ID : </label><br/>
                                     <input type="text" className="form-control" value={this.state.courseId} onChange={this.changecourseId} required/><br/>
                                     <label>Exam Duration : </label><br/>
                                     <input type="text" className="form-control" value={this.state.courseDur} onChange={this.changecourseDur} required/><br/>
                                     <label>Exam Time : </label><br/>
                                     <input type="text" className="form-control" value={this.state.courseFee} onChange={this.changecourseFee} required/><br/>
